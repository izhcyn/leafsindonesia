    ...
    public function store(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'send_as_gift' => 'nullable|boolean',
                'gift_message' => 'nullable|string|max:500',
            ]);

            $isBuyNow = $request->input('isBuyNow') === 'true';
            $selectedItems = $request->input('products');
            $isGift = $request->boolean('send_as_gift'); // Ambil nilai boolean
            $giftMessage = $isGift ? $request->input('gift_message') : null;
            ...
            // Tambahkan pesan gift jika checkbox dicentang
