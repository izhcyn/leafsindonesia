    ...
    @section('content')
        <div class="container my-5">
            ...
            <form action="{{ route('checkout.store') }}" method="POST" onsubmit="handlePlaceOrder(event)">
                @csrf
                ...
                <div class="mb-3">
                    <label for="recipient_address" class="form-label">Recipient's Address</label>
                    <textarea class="form-control" id="recipient_address" name="recipient_address" rows="3" required></textarea>
                </div>
                <div class="mb-3">
                    <label for="recipient_phone" class="form-label">Recipient's Phone WhatsApp Number</label>
                    ...
                    <ul class="list-group">
                        @foreach ($cartItems as $item)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <input type="hidden" name="products[]" value="{{ $item->produk_id }}">
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <label for="subtotal" class="form-label fw-bold display-6">Subtotal</label>
                    <div class="text-end">
                        <h4 id="subtotal">
                            ${{ number_format(
        ...
        <script>
            function handlePlaceOrder(event) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "You will be redirected to WhatsApp for payment.",
                    icon: "warning",
                        ...
                        fetch('{{ route('checkout.store') }}', {
                            ...
                            .then(data => {
                                if (data.success) {
                                    Swal.fire({
                                        title: "Success!",
                                        text: "Redirecting you to WhatsApp for payment.",
                                        icon: "success",
                                        timer: 2000,
                                    ...
                                    Swal.fire("Error!", data.message || "An error occurred. Please try again.",
                                        "error");
                                }
                            })
                            .catch(error => {
