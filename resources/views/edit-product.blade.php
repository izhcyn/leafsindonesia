...
<div class="container" style="margin-top: 100px;">
    ...
    <form action="{{ route('update.product', $produk->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3">
            ...
            <input type="text" class="form-control" id="nama" name="nama" maxlength="100" required value="{{ $produk->nama }}">
        </div>
        <div class="row ">
            <div class="col">
                <div class="mb-3">
                    ...
                    <p class="text-muted mt-2">Gambar saat ini:
                        <img src="{{ asset('storage/' . $produk->image) }}" alt="{{ $produk->nama }}" style="max-width: 100px">
                    </p>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    ...
                    <p class="text-muted mt-2">Gambar saat ini:
                        <img src="{{ asset('storage/' . $produk->image_2) }}" alt="{{ $produk->nama }}" style="max-width: 100px">
                    </p>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    ...
                    <p class="text-muted mt-2">Gambar saat ini:
                        <img src="{{ asset('storage/' . $produk->image_3) }}" alt="{{ $produk->nama }}" style="max-width: 100px">
                    </p>
                </div>
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="genus" name="genus" maxlength="100" required value="{{ $produk->genus }}">
        </div>
        <div class="mb-3">
  ...
  <textarea class="form-control" id="deskripsi" name="deskripsi" maxlength="255" required rows="3">{{ $produk->deskripsi }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="stock" name="stock" required value="{{ $produk->stock }}">
        </div>
