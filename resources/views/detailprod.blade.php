      ...
      <div class="row mt-3">
         <div class="col-md-6">
            <div class="card border-none">
               <img src="{{ asset('storage/' . $produk->image)}}" class="card-img img-fluid" style="height: 24.5em; object-fit: cover;">
            </div>
         ...
         <div class="col-md-6">
            ...
            <hr>
            <p> Price:</p>
            <h2 class="fw-bold"> ${{ number_format($produk->harga, 2) }} </h2>
            <p> Size : </p>
            ...
            <div class="row mt-3 ">
               <div class="col-2">
                  <a class="btn w-100" href=""> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000000" class="bi bi-chat-dots" viewBox="0 0 16 16">
               ...
               <div class="col ">
                <div class="col">
                    @auth
                    <a href="{{ route('add.to.cart', $produk->id) }}" class="btn w-100 text-dark btn-add-to-cart" role="button">
                        Add To Cart
                    </a>
                    @else
