          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            ...
            <div class="mx-auto" style="width: 45%;">
              ...
              <div class="input-group my-3">
                ...
                <input type="text" class="form-control srch" placeholder="Search" aria-label="Search" aria-describedby="Search">

                <span class="input-group-text "  id="basic-addon2"><img src="Aset/icon/search.svg" width="15px"></span>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 ">
              ...
              <ul class="navbar-nav mb-2 mb-lg-0">
                  ...
                  <a href="{{ route('shopcart') }}" class="position-relative my-auto" style="border: none; background-color: transparent; color: inherit; text-decoration: none;">
                ...
                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                  ...
                  @else
                      ...
                      <li class="nav-item">
                          ...
                          <a class="nav-link" href="/register"><img src="Aset/icon/person-fill.svg" width="20px"></a>
